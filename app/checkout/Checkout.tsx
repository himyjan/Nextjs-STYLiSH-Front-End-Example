      ...
      <form>
        ...
        <FormFieldSet>
          ...
          <FormGroup>
            ...
            <FormControl as="div" ref={cardNumberRef as unknown as LegacyRef<HTMLInputElement>} />
          </FormGroup>
          <FormGroup>
            <FormLabel>有效期限</FormLabel>
            <FormControl as="div" ref={cardExpirationDateRef as unknown as LegacyRef<HTMLInputElement>} />
          </FormGroup>
          <FormGroup>
            <FormLabel>安全碼</FormLabel>
            <FormControl as="div" ref={cardCCVRef as unknown as LegacyRef<HTMLInputElement>} />
          </FormGroup>
        </FormFieldSet>
      </form>
      <SubtotalPrice>
